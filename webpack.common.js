...
module.exports = {
  entry: {
    ...
    is_embedded_in_other_website: './src/resources/js/utils/is_embedded_in_other_website.js',
  },
  output: {
  ...
  plugins: [
    ...
    new CopyPlugin({
      patterns: [
        { context: 'src/', from: 'resources/assets/**/*.+(json|png|mp3|wav)' },
    ...
    new HtmlWebpackPlugin({
      ...
      chunks: ['runtime', 'main', 'dark_color_scheme', 'is_embedded_in_other_website'],
    ...
    new HtmlWebpackPlugin({
      ...
      chunks: ['runtime', 'ko', 'main', 'dark_color_scheme', 'is_embedded_in_other_website'],
      chunksSortMode: 'manual',
      minify: { collapseWhitespace: true, removeComments: true },
    }),
    new HtmlWebpackPlugin({
